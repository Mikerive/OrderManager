...
from core.orders.models import OrderStatus, OrderType as CoreOrderType, OrderSide as CoreOrderSide, OrderCreate, OrderEdge
...
from features.order_management.models import ManagedOrder
...
class AlpacaService:
    ...
    async def initialize(self, credentials: AlpacaCredentials) -> None:
        ...
        try:
            ...
            raise UnauthorizedException(f"Failed to initialize Alpaca client: {str(e)}")
    ...
    async def place_order(
        ...
        try:
            ...
            if order_request.type == AlpacaOrderType.STOP:
            ...
            if order_request.type == AlpacaOrderType.TRAILING_STOP:
